...
def capitala_guatemala() -> str:
    return "Ciudad de Guatemala(Guatemala City)"

def steag_guatemala() -> str:
    return """<img src="/static/Drapelul-Guatemalei.png" alt="Drapelul Guatemalei" width="1000" height="600">"""
